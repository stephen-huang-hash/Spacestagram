...
The decision to use React to build the app was because it's a technology I've worked with in the past. I experimented with Shopify Polaris as a framework but I decided to go with Bootstrap, which is something I have more familiarity with.
